<html><h1>jslint(1) -- a code quality tool</h1><h2 id="SYNOPSIS">SYNOPSIS</h2><p>jslint [--indent] [--maxerr] [--maxlen] [--predef] [--edition] [--anon] [--bitwise] [--browser] [--cap] [--continue] [--css] [--debug] [--devel] [--eqeq] [--es5] [--evil] [--forin] [--fragment] [--newcap] [--node] [--nomen] [--on] [--passfail] [--plusplus] [--properties] [--regexp] [--rhino] [--undef] [--unparam] [--sloppy] [--stupid] [--sub] [--vars] [--white] [--widget] [--windows] [--json] [--color] [--terse] [--] &lt;scriptfile&gt;...</p><h2 id="DESCRIPTION">DESCRIPTION</h2><p>JSLint is a static analysis tool to locate and correct style problems in Javascript (ECMAScript etc.) source code.</p><h2 id="META-OPTIONS">META OPTIONS</h2><p>  <code>--color</code>     write output in color</p><p>  <code>--terse</code>     report one error per line with parseable source file/line</p><p>  <code>--json</code>      output in JSON format</p><p>  <code>--edition</code>   specify which edition of jslint to use</p><h2 id="LINTING-OPTIONS">LINTING OPTIONS</h2><p>  <code>--ass</code>       Tolerate assignment expressions</p><p>  <code>--bitwise</code>   Tolerate bitwise operators</p><p>  <code>--browser</code>   Assume a browser</p><p>  <code>--closure</code>   Tolerate Google Closure idioms</p><p>  <code>--continue</code>  Tolerate continue</p><p>  <code>--couch</code>     Assume CouchDB</p><p>  <code>--debug</code>     Tolerate debugger statements</p><p>  <code>--devel</code>     Assume console,alert, ...</p><p>  <code>--eqeq</code>      Tolerate == and !=</p><p>  <code>--evil</code>      Tolerate eval</p><p>  <code>--forin</code>     Tolerate unfiltered for in</p><p>  <code>--indent</code>    Strict white space indentation</p><p>  <code>--maxerr</code>    Maximum number of errors</p><p>  <code>--maxlen</code>    Maximum line length</p><p>  <code>--newcap</code>    Tolerate uncapitalized constructors</p><p>  <code>--node</code>      Assume Node.js</p><p>  <code>--nomen</code>     Tolerate dangling  in identifiers</p><p>  <code>--passfail</code>  Stop on first error</p><p>  <code>--plusplus</code>  Tolerate ++ and --</p><p>  <code>--predef</code>    Predefined</p><p>  <code>--regexp</code>    Tolerate . and [^...]. in /RegExp/</p><p>  <code>--rhino</code>     Assume Rhino</p><p>  <code>--sloppy</code>    Tolerate missing &#39;use strict&#39; pragma</p><p>  <code>--stupid</code>    Tolerate stupidity</p><p>  <code>--sub</code>       Tolerate inefficient subscripting</p><p>  <code>--todo</code>      Tolerate TODO comments</p><p>  <code>--unparam</code>   Tolerate unused parameters</p><p>  <code>--vars</code>      Tolerate many var statements per function</p><p>  <code>--white</code>     Tolerate messy white space</p><h2 id="EXAMPLES">EXAMPLES</h2><p><em>Multiple files:</em></p><pre><code>jslint lib/color.js lib/reporter.js</code></pre><p><em>All JSLint options supported</em></p><pre><code>jslint --white --vars --regexp lib/color.js</code></pre><p><em>Defaults to true, but you can specify false</em></p><pre><code>jslint --bitwise false lib/color.js</code></pre><p><em>Pass arrays</em></p><pre><code>jslint --predef $ --predef Backbone lib/color.js</code></pre><p><em>JSLint your entire project</em></p><pre><code>find . -name &quot;*.js&quot; -print0 | xargs -0 jslint</code></pre><p><em>Using JSLint with a config file</em></p><p>  Start with the included example jslintrc file and customize your options per project
...
e.g., &quot;*&quot; or &quot;&gt;0.2.1&quot;</p><h2 id="RETURN-VALUES">RETURN VALUES</h2><p>jslint returns 1 if it found any problems, 0 otherwise.</p><h2 id="AUTHOR">AUTHOR</h2><p>jslint is written and maintained by Douglas Crockford
    https://github.com/douglascrockford/JSLint</p><p>This package is node-jslint, which provides a command-line interface for
running jslint using the nodejs platform.  node-jslint was written by Reid Burke
and is maintained by Reid Burke, Ryuichi Okumura, and Sam Mikes.</p><h2 id="BUGS">BUGS</h2><p>There are no known bugs.  Submit bugs to 
    https://github.com/reid/node-jslint/issues</p><p>Note that if you are reporting a problem with the way <em>jslint</em> works rather than the way 
the command-line tools work, we will probably refer you to the JSLint issue tracker at
    https://github.com/douglascrockford/JSLint/issues</p></html>
